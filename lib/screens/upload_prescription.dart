  ...
  Widget build(BuildContext context) {
    ...
    SavingBase64ImageSingleUser(
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => ThankYou(BilLNuMbEr,billDATE)));
      } else {
        ...
        Padding(
          ...
          child: InkWell(
            onTap: () async {
              ...
              String sessionId = prefs.getString('SESSIONID') ?? "Not Assigned";
              ...
              if (_selectedImages.isNotEmpty) {
                ...
                // Show an error message to the user that no image is selected
              }
