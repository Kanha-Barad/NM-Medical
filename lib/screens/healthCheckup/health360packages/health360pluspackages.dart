                ...
                child: Container(
                  ...
                  decoration: const BoxDecoration(
                      ...
                      image: DecorationImage(
                          image: AssetImage(
                              "assets/healththreesixty/health-360-plus-title.png"),
                          fit: BoxFit.fitHeight)),
                ),
              ),
              const Padding(
                padding: EdgeInsets.only(left: 15),
                child: Text("HEALTH 360 PLUS",
                    style: TextStyle(
                        color: Colors.white,
                ...
                Column(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Text("Health 360 Plus Investment",
                          style: TextStyle(
                              fontSize: 15, fontWeight: FontWeight.w700)),
                    ),
                    Padding(
                      padding: EdgeInsets.fromLTRB(8, 2, 0, 6),
                      child: Text('\u{20B9} ${value.format(29500)}',
                          style: TextStyle(
          ...
          child: Row(
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "64 Slice Cardiac CT is an ultra-fast non-invasive\ntechnique to screen for blockages in\nthe coronary arteries",
                ),
              )
            ],
          ),
          ...
          child: Row(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(right: 8.0),
                child: Text(
                  "Introducing non - invasive MRI Renal Angio to\nscreen for renal artery disease commonly seen\nin Cardiac, Diabetic, & Hypertensive patients",
                ),
              )
            ],
          ),
        ...
        Padding(
          ...
          child: Container(
            ...
            decoration: const BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage(
                      "assets/healththreesixty/health360-plus-img.jpg"),
                  fit: BoxFit.fitHeight,
                )),
          ),
        ),
