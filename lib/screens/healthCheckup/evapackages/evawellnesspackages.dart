    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        InkWell(
          onTap: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => EVaSilverPackage()));
          },
          child: Padding(
        ...
        InkWell(
          onTap: () {
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => EVaGoldPackage()));
          },
          child: Padding(
        ...
        InkWell(
            ...
            child: Padding(
              ...
              child: SizedBox(
                  height: 129,
                  width: 200,
                  child: Image.asset("assets/images/meun-platinum-card.png")),
            )),
        Padding(
          padding: const EdgeInsets.only(top: 4.0, bottom: 5),
          child: Text(
