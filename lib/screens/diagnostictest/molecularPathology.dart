      ...
      body: CustomScrollView(slivers: [
        SliverPersistentHeader(
          ...
          delegate: CustomContainerBarDelegate(
            ...
            svgAssetPath:
                "assets/diagnostic-test/molecular-pathology-title.svg",
            onBackButtonPressed: () {
            ...
            child: SingleChildScrollView(
              ...
              ListTile(
                leading: SvgPicture.asset(
                    "assets/diagnostic-test/sars-cov2-icon.svg"),
              ...
              ListTile(
                leading: SvgPicture.asset(
                    "assets/diagnostic-test/respirastat-icon.svg"),
              ...
              ListTile(
                leading: SvgPicture.asset(
                    "assets/diagnostic-test/gastrostat-icon.svg"),
              ...
              ListTile(
                leading: SvgPicture.asset(
                    "assets/diagnostic-test/torch-pcr-icon.svg"),
              ...
              ListTile(
                leading: SvgPicture.asset(
                    "assets/diagnostic-test/prostate-cancer.svg"),
              ...
              ListTile(
                leading: SvgPicture.asset(
                    "assets/diagnostic-test/torch-pcr-icon2.svg"),
              ...
              ListTile(
                leading: SvgPicture.asset(
                    "assets/diagnostic-test/neurology-icon-nav.svg"),
              ...
              ListTile(
                leading: Padding(
                  ...
                  child: SvgPicture.asset(
                      "assets/diagnostic-test/medical-icon.svg"),
                ),
                title: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                          ...
                          child: Text(
                              "Dermatology : Skin & Hair, Gastroenterology",
                              style: TextStyle(
                                fontSize: 14,
                                height: 1.4,
                              ))),
              ...
              ListTile(
                leading: Padding(
                  ...
                  child: SvgPicture.asset(
                      "assets/diagnostic-test/reproductive-img.svg"),
                ),
                title: Padding(
                  padding: const EdgeInsets.only(top: 8.0, left: 16),
              ...
              ListTile(
                leading: Padding(
                  ...
                  child: SvgPicture.asset(
                      "assets/diagnostic-test/oncology-img.svg"),
                ),
                title: Padding(
              ...
              ListTile(
                leading:
                    SvgPicture.asset("assets/diagnostic-test/wellness-img.svg"),
                title: Padding(
