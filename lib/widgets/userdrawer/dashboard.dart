      ...
      body: CustomScrollView(slivers: [
        ...
        SliverToBoxAdapter(
            child: SingleChildScrollView(
              ...
              FutureBuilder<List<OTPValidationResponse>>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      // Render empty labels when data is not available
              ...
              FutureBuilder<List<OTPValidationResponse>>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      if (_validResponseData == null ||
                          _validResponseData.isEmpty) {
                        // Render empty address
                        return Padding(
                          padding: const EdgeInsets.fromLTRB(16, 10, 0, 6),
                          child: Text('No data available.'),
                        );
                      } else {
                        // Render address with data
                        return Padding(
                          padding: const EdgeInsets.fromLTRB(10, 8, 10, 8),
                          child: Container(
                              decoration: BoxDecoration(
