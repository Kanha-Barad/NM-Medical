    ...
    return Drawer(
      child: ListView(children: <Widget>[
        ...
        ListTile(
            ...
            leading: SvgPicture.asset("assets/menu-icons/health-check-up.svg"),
            title: const Text(
              "Health Check up",
              style: TextStyle(
                  fontSize: 14,
        ...
        ListTile(
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => CancerAnDGEnomiCS()));
            },
            leading: SvgPicture.asset("assets/menu-icons/cancer-genomics.svg"),
            title: const Text(
              "Cancer & Genomics",
              style: TextStyle(
                  fontSize: 14,
        ...
        ListTile(
            ...
            leading:
                SvgPicture.asset("assets/menu-icons/download-all-reports.svg"),
            title: const Text(
